...
if not GENAI_API_KEY:
    raise ValueError("API Key not found! Please check your Render environment variables.")
...
class PrivacyVault:
    def __init__(self):
        ...
        # Force Presidio to use the Small (Low-RAM) model for Render Free Tier
        configuration = {
        ...
        # Boot up the Analyzer with the new engine
